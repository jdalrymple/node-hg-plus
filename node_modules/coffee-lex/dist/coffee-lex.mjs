...
export { AT, BOOL, BREAK, CATCH, CALL_END, CALL_START, CLASS, COLON, COMMA, COMMENT, CONTINUATION, CONTINUE, DELETE, DO, DOT, DSTRING_START, DSTRING_END, ELSE, EOF, EXISTENCE, FINALLY, FOR, FUNCTION, HERECOMMENT, HEREGEXP_START, HEREGEXP_END, IF, INTERPOLATION_START, INTERPOLATION_END, JS, LBRACE, LBRACKET, LOOP, LPAREN, NEWLINE, NORMAL, NULL, NUMBER, OPERATOR, OWN, PROTO, RANGE, REGEXP, RBRACE, RBRACKET, RELATION, RETURN, RPAREN, SEMICOLON, SPACE, SUPER, SWITCH, SSTRING_START, SSTRING_END, STRING_CONTENT, STRING_LINE_SEPARATOR, STRING_PADDING, TDSTRING_START, TDSTRING_END, THEN, THIS, TRY, TSSTRING_START, TSSTRING_END, UNDEFINED, UNKNOWN, WHEN, WHILE, IDENTIFIER, YIELD, YIELDFROM, stream, consumeStream };export default lex;
