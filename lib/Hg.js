...
*/
class Hg {
  constructor(options = { pythonPath: 'python' }) {
   ...
   */
  static clone(from, to = undefined, done = undefined) {
    return cloneOrMergeMany(from, to, this.pythonPath)
      .asCallback(done);
  }

  static create(to = undefined, done = undefined) {
